...
h1 = fIn1.Get("top1_mass")
h2 = fIn1.Get("top2_mass")
h3 = fIn1.Get("top3_mass")
h4 = fIn1.Get("top4_mass")
...
h1.SetTitle("")
h1.GetXaxis().SetTitle("mass_{top} [GeV]")
...
legend.AddEntry(h1, "top1 mass", "l")
legend.AddEntry(h2, "top2 mass", "l")
legend.AddEntry(h3, "top3 mass", "l")
legend.AddEntry(h4, "top4 mass", "l")
legend.Draw()
